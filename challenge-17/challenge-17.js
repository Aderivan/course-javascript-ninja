(function () {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/g, 'José Aderivan'))
    ...
    */
    ...
    console.log(text.replace(/[D-Hd-d]/g, '0'))
    ...
    */
    ...
    console.log('O Centauro de Luvas'.replace(/(\w)/g, function (pharse) {
