(function () {
    ...
    */
    ...
    var norte = brasil.unshift('Pará', 'Amazonas', 'Acre')
    console.log(brasil);
    ...
    */
    ...
    var nordeste = ['Pernambuco', 'Bahia', 'João Pessoa', 'Ceará'];
    ...
    */
    ...
    console.log('novo sudeste ', newSudeste)
    ...
    */
    ...
    var existe = brasil.map(function (item) {
        item === 'Ceará';
    })
    ...
    */
    ...
    var pares = map.filter(function (item, indice) {
        return item.id % 2 === 0;
    })
